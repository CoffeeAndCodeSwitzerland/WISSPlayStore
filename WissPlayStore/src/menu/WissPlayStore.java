...
public class WissPlayStore extends PApplet {
	...
	/*
	 * args are used to start a game or to give the application the username and the learpoints
	 * for the username and points they have to be written like this: username;learnpoints 
	 * Example MyUser;100
	 */
